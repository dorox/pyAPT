...
class Controller(object):
    ...
    def status(self, channel=1):
        ...
        """
        reqmsg = Message(message.MGMSG_MOT_REQ_STATUSUPDATE, param1=channel)
        self._send_message(reqmsg)

        getmsg = self._wait_message(message.MGMSG_MOT_GET_STATUSUPDATE)
    ...
    def home(self, wait=True, velocity=None, offset=0):
        ...
        homeparamsmsg = Message(
            message.MGMSG_MOT_SET_HOMEPARAMS, data=newparams)
    ...
    def keepalive(self):
        ...
        Case 2: Stepper motors
        This sends MGMSG_MOT_ACK_STATUSUPDATE to the controller to keep it
        from going dark.
